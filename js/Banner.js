AFRAME.registerComponent("banner", {
    ...
    tick:function(){
      const{state}=this.el.getAttribute('banner')
      if(state==='view'){
        this.hideEl([this.comicContainer])
        this.showView()
      }
    },
    ...
    showView:function(){
      ...
      skyEl.setAttribute('material',{
        src:`./assets/360_images/${selectedCard}/comic-0.jpeg`,
        color:'white'
      })
    },
    createCards: function () {
      const thumbNailsRef = [
        ...
        },
        {
          id: "blackP",
          title: "Black Panther",
          url: "./assets/thumbnails/blackP.jpeg",
        },
  
        {
          id: "marvelC",
          title: "Captain Marvel",
          url: "./assets/thumbnails/marvelC.jpeg",
        },
        {
          id: "spiderM",
          title: "SpiderMan",
          url: "./assets/thumbnails/spiderM.jpeg",
        },
      ];
